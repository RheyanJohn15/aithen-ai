    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-3">
          <div>
            <h1 className="text-xl font-semibold text-gray-900 dark:text-white mb-1">API Keys</h1>
      ...
      {/* Warning */}
      <div className="mb-6 p-3 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800/50 rounded-lg">
      ...
      <div className="space-y-3">
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <div className="flex items-center space-x-2 mb-2">
                  <Key className="w-4 h-4 text-[var(--color-aithen-teal)]" />
                  <h3 className="text-sm font-semibold text-gray-900 dark:text-white">{apiKey.name}</h3>
                </div>
                <div className="flex items-center space-x-2 mb-2">
        ...
        {apiKeys.length === 0 && (
          <div className="text-center py-12 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
            ...
            <p className="text-xs text-gray-400 dark:text-gray-500 mb-4">Create your first API key to get started</p>
            <Button
              onClick={() => setShowCreateModal(true)}
              leftIcon={<Plus className="w-3.5 h-3.5" />}
            >
      ...
      <div className="mt-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
        <h2 className="text-sm font-semibold text-gray-900 dark:text-white mb-3">API Documentation</h2>
