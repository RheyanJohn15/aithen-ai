        ...
        <div className="text-center">
          ...
          {error && (
            <div className="mt-4 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg max-w-md mx-auto">
              <p className="text-sm text-red-800 dark:text-red-200 font-semibold mb-2">Error:</p>
              ...
              <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-6">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-red-600 dark:text-red-300 mb-4 break-all">
                      {error}
                    </p>
                    <div className="space-y-2 text-xs text-red-500 dark:text-red-400">
